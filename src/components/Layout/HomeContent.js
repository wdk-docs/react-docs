    ...
    <>
      <div className="ps-0">
        ...
        <Section background="left-card">
          <Center>
            <Header>从组件创建用户界面</Header>
            <Para>
              React允许您从称为组件的各个部分构建用户界面。创建自己的React组件，如{' '}
              <Code>Thumbnail</Code>, <Code>LikeButton</Code>, 和{' '}
              <Code>Video</Code>. 然后将它们组合到整个屏幕、页面和应用程序中。
            </Para>
          </Center>
          <FullBleed>
            <Example1 />
          ...
          <Center>
            <Para>
              无论你是自己工作还是与成千上万的其他开发人员合作，使用React都是一样的。
              它旨在让您无缝地组合由独立人员、团队和组织编写的组件。
            </Para>
          </Center>
        </Section>
        ...
        <Section background="right-card">
          <Center>
            <Header>使用代码和标记编写组件</Header>
            <Para>
              React组件是JavaScript函数。 想有条件地显示一些内容吗？ 使用{' '}
              <Code>if</Code> 陈述. 是否显示列表？ 尝试数组 <Code>map()</Code>.
              学习React就是学习编程。
            </Para>
          </Center>
          <FullBleed>
          ...
          <Center>
            <Para>
              这种标记语法称为JSX。它是React推广的JavaScript语法扩展。
              将JSX标记靠近相关的呈现逻辑，可以使React组件易于创建、维护和删除。
            </Para>
          </Center>
        </Section>
        ...
        <Section background="left-card">
          <Center>
            <Header>随时随地添加互动功能</Header>
            <Para>
              React组件接收数据并返回屏幕上应显示的内容。
              您可以向他们传递新数据以响应交互，比如当用户键入输入时。
              React随后将更新屏幕以匹配新数据。
            </Para>
          </Center>
          <FullBleed>
          ...
          <Center>
            <Para>
              您不必在React中构建整个页面。
              将React添加到现有的HTML页面中，并在其任何位置呈现交互式React组件。
            </Para>
        ...
        <Section background="right-card">
          <Center>
            <Header>
              使用框架进行全栈 <br className="hidden lg:inline" />
            </Header>
            <Para>
              React是一个库。
              它允许您将组件放在一起，但没有规定如何进行路由和数据获取。
              要使用React构建整个应用程序，我们建议使用全栈React框架，如{' '}
          ...
          <Center>
            <Para>
              React也是一种架构。
              实现它的框架允许您在服务器上甚至在构建过程中运行的异步组件中获取数据。
              从文件或数据库中读取数据，并将其传递给交互式组件。
            </Para>
            <div className="flex justify-start w-full lg:justify-center">
              <CTA
                color="gray"
        ...
        <Section background="left-card">
          <div className="mx-auto flex flex-col w-full">
            <div className="mx-auto max-w-4xl lg:text-center items-center px-5 flex flex-col">
              <Header>使用每个平台的最佳功能</Header>
              <Para>
                人们喜欢网络和原生应用程序的原因各不相同。
                React允许您使用相同的技能构建web应用程序和原生应用程序。
                它依靠每个平台的独特优势，让您的界面在每个平台上都感觉恰到好处。
              </Para>
            </div>
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="relative flex items-start justify-center flex-col flex-1 pb-16 pt-5 gap-3 px-5 lg:px-10 lg:pt-8">
                      ...
                      <p className="lg:text-xl leading-normal text-secondary">
                        人们期望web应用程序页面能够快速加载。
                        在服务器上，React允许您在获取数据时开始流式传输HTML，在加载任何JavaScript代码之前逐步填充剩余内容。
                        在客户端上，React可以使用标准的web
                        API来保持UI的响应性，即使在渲染过程中也是如此。
                      </p>
                    </div>
                  </div>
                </BrowserChrome>
                    ...
                    <div className="bg-gradient-right dark:bg-gradient-right-dark px-3 sm:px-3 pb-12 lg:pb-20 rounded-lg overflow-hidden">
                      ...
                      <div className="flex flex-col items-start justify-center pt-0 gap-3 px-2.5 lg:pt-8 lg:px-8">
                        ...
                        <p className="h-full lg:text-xl text-secondary dark:text-secondary-dark leading-normal">
                          人们期望原生应用程序在外观和感觉上都像他们的平台。{' '}
                          <Link href="https://reactnative.dev">
                            React Native
                          </Link>{' '}
                          和{' '}
                          <Link href="https://github.com/expo/expo">Expo</Link>{' '}
                          让您在React中为Android、iOS等构建应用程序。
                          他们看起来和感觉都是原生的，因为他们的UIs <i>是</i>
                          真正的原生.
                          这不是一个web视图——您的React组件呈现平台提供的真实Android和iOS视图。
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="px-5 lg:px-0 max-w-4xl mx-auto lg:text-center text-secondary dark:text-secondary-dark">
              <Para>
                使用React，您可以成为一个web<i>和</i>原生开发人员。
                您的团队可以在不牺牲用户体验的情况下运送到许多平台。
                您的组织可以桥接平台竖井，并组建端到端拥有整个功能的团队。
              </Para>
              <div className="flex justify-start w-full lg:justify-center">
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row px-5">
            <div className="max-w-3xl lg:max-w-7xl gap-5 flex flex-col lg:flex-row lg:px-5">
              <div className="w-full lg:w-6/12 max-w-3xl flex flex-col items-start justify-start lg:ps-5 lg:pe-10">
                <Header>在未来准备就绪时升级</Header>
                <Para>
                  谨慎应对方法变化。每个React提交都在拥有超过10亿用户的业务关键型表面上进行测试。
                  Meta超过100000个React组件帮助验证每一种迁移策略。
                </Para>
                <div className="order-last pt-5">
                  <Para>
                    React团队一直在研究如何改进React。
                    有些研究需要数年时间才能见效。
                    React对将研究理念转化为生产有很高的要求。只有经过验证的方法才能成为React的一部分。
                  </Para>
          ...
          <div className="w-full">
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                ...
                <Para>
                  你并不孤单。来自世界各地的200万开发人员每月访问React文档。React是人们和团队可以达成一致的东西。
                </Para>
              </Center>
            </div>
            <CommunityGallery />
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Para>
                  这就是为什么React不仅仅是一个库、一个架构，甚至是一个生态系统。React是一个社区。这是一个你可以寻求帮助、寻找机会和结识新朋友的地方。你会遇到开发人员和设计师，初学者和专家，研究人员和艺术家，老师和学生。我们的背景可能非常不同，但React可以让我们一起创建用户界面。
                </Para>
              </Center>
            </div>
          </div>

    ...
    <footer className={cn('text-secondary dark:text-secondary-dark')}>
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-x-12 gap-y-8 max-w-7xl mx-auto">
        <div className="col-span-2 md:col-span-1 justify-items-start mt-3.5">
          <ExternalLink href="https://opensource.fb.com/" aria-label="元开源">
            <div>
              <svg
                width="160"
                height="19"
        ...
        <div className="flex flex-col">
          ...
          <FooterLink href="/learn/describing-the-ui">描述UI</FooterLink>
          <FooterLink href="/learn/adding-interactivity">添加交互性</FooterLink>
          <FooterLink href="/learn/managing-state">管理状态</FooterLink>
          <FooterLink href="/learn/escape-hatches">逃生舱口</FooterLink>
        </div>
        <div className="flex flex-col">
        ...
        <div className="md:col-start-2 xl:col-start-4 flex flex-col">
          ...
          <FooterLink href="/community/team">与团队会面</FooterLink>
        ...
        <div className="flex flex-col">
          ...
          <FooterLink href="https://reactnative.dev/">React 原生</FooterLink>
